...
-define(LOG_SHOW_RESPONSE_MAX_LENGTH_DEFAULT, 150).
-define(LOG_SHOW_PAYLOAD_MAX_LENGTH_DEFAULT, 150).
-define(RESULT_CACHE_DEFAULT, 15000).
-define(SMTP_PORT_DEFAULT, 587).
-define(RATE_LIMIT_INTERNO_DEFAULT, 120).
-define(RATE_LIMIT_EXTERNO_DEFAULT, 120).
