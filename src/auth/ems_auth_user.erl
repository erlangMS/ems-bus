		...
		false -> 
			case oauth2:verify_access_token(AccessToken, undefined) of
				...
				case Client =/= undefined of
					true ->
							case Client#client.user_agent =:= undefined andalso
								Req#request.user_agent =:= undefined andalso
								Client#client.forwarded_for =:= undefined andalso
								Req#request.forwarded_for =:= undefined andalso
								Client#client.user_agent =:= Req#request.user_agent andalso
