...
find_index_by_login_and_password([Table|_] = Tables, 
	...
	case IsMatch of
			true -> 
				...
				ems_cache:add(ems_user_cache, ?USER_CACHE_POSITIVE_TTL, {Table, LoginBin}, [User2]),
				{ok, User2};
			false -> 
	...
	try
		...
		put(get_user_info, get_user_info_pass3),
				iolist_to_binary([<<"{"/utf8>>,
									...
									<<"\"cpf\":\""/utf8>>, CPF,<<"\","/utf8>>,
									<<"\"address\":\""/utf8>>, StreetAddress,<<" "/utf8>>, Locality, 
										<<" "/utf8>>,Region,<<" "/utf8>>,PostalCode, <<" Brasil\""/utf8>>, <<","/utf8>>,
