...
start(_StartType, StartArgs) ->
	...
	case ems_config:start() of
		{ok, _Pid} ->
			...
			ems_logger:info("  \033[0;32mauth_default_scopes\033[0m: \033[01;34m~p\033[0m.", [Conf#config.auth_default_scopes]),
			ems_logger:info("  \033[0;32mauth_password_check_between_scopes\033[0m: \033[01;34m~p\033[0m.", [Conf#config.auth_password_check_between_scopes]),
