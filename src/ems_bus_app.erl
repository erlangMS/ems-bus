...
start(_StartType, StartArgs) ->
	io:format("\n"),
	ems_logger:format_info("Loading ~s ( \033[0;32mPID:\033[0m \033[01;34m~s\033[0m  \033[0;32mErlang/OTP Version:\033[0m \033[01;34m~s\033[0m )", [?SERVER_NAME, os:getpid(), erlang:system_info(otp_release)]),
	case ems_config:start() of
		{ok, _Pid} ->
			...
			ems_logger:info("  \033[0;32mhttp_max_content_length\033[0m: \033[01;34m~p bytes (~p KB, ~p MB, ~p GB)\033[0m.", [Conf#config.http_max_content_length, round(Conf#config.http_max_content_length/1024), round(Conf#config.http_max_content_length/1048576), round(Conf#config.http_max_content_length/1073741824)]),
